class FinancialRecord:
    ...
    def __str__(self):
        return (f"FinancialRecord[ID={self.__record_id}, EmployeeID={self.__employee_id}, Date={self.__record_date}, "
                f"Description={self.__description}, Amount={self.__amount}, Type={self.__record_type}]")