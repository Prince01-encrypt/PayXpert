class Tax:
    ...
    def __str__(self):
        return f"Tax (taxId = {self.__tax_id}, employeeID = {self.__employee_id}, taxYear = {self.__tax_year}, taxableIncome = {self.__taxable_income}, taxAmount = {self.__tax_amount})"